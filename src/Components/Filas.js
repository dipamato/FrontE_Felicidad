  ...
  return (
    <>
      ...
      <td
        ...
        > <span style={{marginInlineStart:"118px",  color: "white",
        padding: "8px",
        fontSize:"16px",
        whiteSpace: "pre-wrap",
        wordWrap: "break-word", marginInlineEnd:"122px",
        }}>
      ...
      <div className="d-flex justify-content-center align-items-center">
        <td style={{ color: "#485767", padding: "8px" }} colSpan={11}>
          ...
          <td>
            <label style={{ display: "center", alignItems: "center" }}>
              ...
              <Input
                ...
                style={{ transform: "scale(1.5)", marginRight: "7px", border:"2px solid #485767"}}
          ...
          <td>
            <span
              style={{ color: "#485767", fontSize: "12px", marginLeft: "18px" }}
            >
