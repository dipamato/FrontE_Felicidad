...
console.log("Recursos",Recursos) //borrar
    if(nombreOtraInstitucion){
      ...
      data = { Institucion: nombreOtraInstitucion.toUpperCase(), Sede: seleccionLista2, Recursos
      ...
      axios
        ...
        .then((response) => {
          ...
          axios.post(`${apiUrl}/respuestas-e/${id}`, data, {
            headers: {
  ...
  return (
    <Container className="custom-container" >
      <br/>
      <h2 style={{ color: "#485767", fontWeight:"50px",fontFamily:"'kalam bold', sans-serif" }}>Caracterización</h2>
      <Form>
        {/**## SELECT INSTITUCIÓN ##**/}
 ...
 <FormGroup className="input-group mb-3">
        ...
        <FormGroup className="input-group mb-3">
          <Input
            ...
            disabled={!seleccionLista1&& (seleccionLista1=== 'OTRA INSTITUCIÓN')}
          >
        ...
        <FormGroup className="input-group mb-3">
          ...
          {errors.hijos && (
            <FormFeedback>{errors.hijos}</FormFeedback>
          )}
