...
function FormPersona() {
    ...
    datosP.map((x) => {
      ...
      switch (currentDimension) {
        ...
        case "Dominio Ambiental en el trabajo":
          ...
          console.log("preguntas ",x.Pregunta.Numero)
  ...
  return (
    <Container className="containerSe">
      ...
      <h2 style={{ color: "#485767", fontFamily: "kalam bold" }}>
        Al finalizar la página encontrarás el reporte del nivel de su felicidad
        en el trabajo
      </h2>
{/**Primer Form */}
      <>
      ...
      >
        Si no está interesado omita estas preguntas
      </p>
...
color:"#144853"
                ...
                Nota:  <br/>En agradecimiento se le entregará un informe de la precepción de los grupos que nos indique respecto a la experiencia de aprendizaje con usted.</p></div>
                <br />
              <FormGroup className="input-group flex-nowrap">
