      ...
      <Form>
          ...
          <div className="containerFormPersona1">
            <Card className="cardFinal1">
              <CardBody>
                ...
                >
                  Si la Regional a la que pertenece no esta en la lista, por favor
                  seleccione la  opción "OTRA REGIONAL", al final de la
                  lista y diligencie los datos que se le solicitarán.
                </p>
              </CardBody>
            </Card>
          </div>
          ...
          <>
            <FormGroup className="input-group mb-3">
              <Input
                ...
                type="text"
                placeholder="Nombre de la Regional (Favor digite en mayúsculas sin tildes el nombre completo de la
                  regional.)"
            ...
            <FormGroup className="input-group mb-3">
              <Input
                className="form-control custom-input"
                type="text"
                placeholder="Nombre del Centro (Favor digite en mayúsculas sin tildes el nombre completo de la
                  regional.)"
        ...
        <FormGroup className="input-group mb-3">
          ...
          >
            ...
            {opcionesLista2.map((opcion) =>
              opcion.Sedes.sort((sedeA, sedeB) =>
                sedeA.Nombre.localeCompare(sedeB.Nombre)
              ).map((sede) => (
        ...
        <FormGroup className="input-group mb-3">
          <Input
            ...
            min="0"
            max="100"
            placeholder="Indique el grado en el escalafon (Si es contratista SENA, por favor sólo digite NA)"
          ...
          Combinaciones entre numeros y letras asi: 2A ó 3C ó 14
            ...
          </FormText>
        </FormGroup>
        ...
        <FormGroup className="input-group mb-3">
          ...
          >
            ...
            <option>Articulación con la Media</option>
            <option>Técnicos - Tecnólogos Presenciales</option>
            <option>Técnicos - Tecnólogos Virtuales</option>
...
export default CaracterizacionSena1;
