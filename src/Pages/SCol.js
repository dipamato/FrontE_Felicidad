          ...
          <div className="containerFormPersona1">
            <Card className="cardFinal1">
              <CardBody>
                ...
                >
                  Si no encuentra su Institución en la lista, por favor
                  seleccione la última opción "OTRA INSTITUCIÓN", al final de la
        ...
        <FormGroup className="input-group mb-3">
          ...
          >
            ...
            {opcionesFiltradas.map((opcion) =>
              opcion.Nombre !== "SENA - REGIONAL CALDAS" && opcion.Nombre !== "Instituciones Educativas de Caldas" ? (
