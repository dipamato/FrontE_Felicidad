...
function Caracterizacion() {
    ...
    if (!nombreOtraInstitucion) {
      async function cargarOpcionesLista2() {
        const response = await axios.get(
          `${apiUrl}/institucion/${"Instituciones Educativas de Caldas"}`
        );
  ...
  function handleClick() {
    if (validateForm()) {
      ...
      if (seleccionLista2==="OTRA INSTITUCIÓN") {
        data = {
          Institucion: "Instituciones Educativas de Caldas" + " - "+seleccionLista1,
          Sede: sedeOtraInstitucion,
          Recursos,
        };
      } else {
        data = { Institucion: "Instituciones Educativas de Caldas" + " - "+seleccionLista1, Sede: seleccionLista2 };
      }
    ...
    <Container className="custom-container">
      ...
      >
        ¡¡¡ IMPORTANTE !!!
              ...
              >
                Si su institución es privada seleccione la opción “OTRA INSTITUCIÓN”, al final de la lista y diligencie los datos que se le solicitarán.
              </p>
      ...
      >
        ...
        <FormGroup className="input-group mb-3">
          <Input
            ...
            value={seleccionLista2}
            onChange={handleChangeLista2}
            disabled={
              !seleccionLista1 && seleccionLista1 === "OTRA INSTITUCIÓN"
            }
          >
            <option value="">Seleccione Institución</option>
            {opcionesLista2.map((opcion) =>
  opcion.Sedes
    .filter((sede) => sede.Municipio === seleccionLista1.toUpperCase()) // Reemplaza AlgunAtributo con el atributo que deseas comparar
    .sort((sedeA, sedeB) => sedeA.Nombre.localeCompare(sedeB.Nombre))
    .map((sede) => (
      <option key={sede.id} value={sede.valor}>
        ...
        {seleccionLista2 === "OTRA INSTITUCIÓN" && (
          <>
          <FormGroup className="input-group mb-3">
              <Input
                className="form-control custom-input"
                type="text"
                placeholder="Nombre de la Institución"
                value={"Instuciones Educativas de Caldas"}
                style={{
                  backgroundColor: "#485767",
                  color: "#dee1e4",
                }}
        ...
        <FormGroup className="input-group mb-3">
          ...
          >
            ...
            <option>Decreto 2277</option>
            <option>Decreto 1278</option>
        ...
        <FormGroup className="input-group mb-3">
          <Input
            ...
            min="0"
            max="100"
            placeholder="Indique el grado en el escalafon"
          ...
          <FormText className="input-group mb-3 custom-form-text">
            Ingrese solo combinaciones entre numeros y letras asi: 2A ó 3C ó 14
            ...
          </FormText>
        </FormGroup>
